    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Call-Up Slips</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Tawag-Pansin Management</p>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select name="status" class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" onchange="this.form.submit()">
            ...
            <div class="flex items-end gap-2">
                ...
                <?php if (!empty($searchQuery) || $filterStatus !== 'all'): ?>
                    <a href="call-up-list.php" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        Clear
                    </a>
                <?php endif; ?>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <?php if (empty($slips)): ?>
            <div class="text-center py-12 px-4">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No Call-Up Slips Found</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Create your first call-up slip to get started.</p>
                <a href="call-up.php" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-600 transition-colors shadow-sm">
                    Create Call-Up
                </a>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        <?php foreach ($slips as $slip): 
                            ...
                            // Status badges
                            $statusColors = [
                                'issued' => 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400',
                            ...
                            $statusBadge = $statusColors[$slip['status']] ?? 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300';
                        ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-medium text-gray-900 dark:text-gray-100 name-mono cursor-pointer" 
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <?php if (!empty($slip['pdf_file_id'])): ?>
                                        ...
                                        <form method="POST" style="display: inline;" onsubmit="showInlineLoader(this, event)">
                                            ...
                                            <button type="submit"
                                                class="inline-flex items-center justify-center w-8 h-8 text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/30 rounded-lg transition-colors"
                                    ...
                                    <?php else: ?>
                                        ...
                                        <form method="POST" style="display: inline;" onsubmit="showInlineLoader(this, event)">
                                            ...
                                            <input type="hidden" name="slip_id" value="<?php echo $slip['slip_id']; ?>">
                                            <button type="submit"
                                                class="inline-flex items-center justify-center w-8 h-8 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors"
                                                title="Generate PDF">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/>
                                                </svg>
                                    ...
                                    <button onclick="markResponded(<?php echo $slip['slip_id']; ?>)" 
                                        class="inline-flex items-center justify-center w-8 h-8 text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/30 rounded-lg transition-colors"
                                    ...
                                    <form method="POST" class="inline" 
                                        ...
                                        <button type="submit" 
                                            class="inline-flex items-center justify-center w-8 h-8 text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors" 
                                            title="Cancel">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form method="POST" class="inline" 
                                        ...
                                        <button type="submit" 
                                            class="inline-flex items-center justify-center w-8 h-8 text-gray-600 dark:text-gray-400 hover:text-red-700 dark:hover:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg transition-colors" 
...
<div id="respondModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Mark as Responded</h3>
        </div>
        ...
        <form method="POST">
            ...
            <div class="px-6 py-4">
                ...
                <textarea name="response_notes" 
                    class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm" 
                    rows="4"
                    placeholder="Enter any notes about the response..."></textarea>
            </div>
            
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 flex justify-end gap-2 rounded-b-lg">
                <button type="button" 
