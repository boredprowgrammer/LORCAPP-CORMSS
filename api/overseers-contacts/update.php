...
try {
    ...
    // Log audit
    logAudit($data['contactId'], 'update', $oldContact, $data, $currentUser['user_id'], $db);
    ...
    error_log("Error updating overseers contact: " . $e->getMessage());
