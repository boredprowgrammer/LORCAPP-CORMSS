...
function detectAppContext() {
    ...
    return null; // No specific app context (dashboard, settings, etc.)
}
...
<head>
    ...
    <style nonce="<?php echo $csp_nonce; ?>">
        ...
        * {
        ...
        /* Form inputs - Base styles with modern launchpad theme */
        ...
        .dark select {
            ...
            color: #f3f4f6;
            border-radius: 0.75rem; /* rounded-xl for modern look */
        ...
        /* Primary buttons - Blue with modern launchpad styling */
        .dark .bg-blue-500,
        .dark .bg-blue-600 {
        ...
        /* Success buttons - Green with modern styling */
        .dark .bg-green-500,
        .dark .bg-green-600 {
        ...
        /* Danger buttons - Red with modern styling */
        .dark .bg-red-500,
        .dark .bg-red-600 {
        ...
        /* Warning buttons - Yellow/Amber with modern styling */
        .dark .bg-yellow-500,
        .dark .bg-yellow-600,
        .dark .bg-amber-500,
        .dark .bg-amber-600 {
        ...
        /* Card hover effects - Subtle lift with modern shadows */
        .dark .bg-white:hover,
        .dark [class*="rounded-lg"]:hover,
        ...
        .dark .group:hover .group-hover\:translate-x-1 {
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen antialiased transition-colors duration-300">
                ...
                <header class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40">
                    <div class="max-w-7xl mx-auto px-6">
                        <div class="flex items-center justify-between h-16">
                            <!-- Left: Page Title & App Link -->
                            <div class="flex items-center gap-4">
                                <a href="<?php echo BASE_URL; ?>/launchpad.php" 
                                   class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-all duration-200">
                            ...
                            <!-- Right: Clock, User Info, Actions -->
                            <div class="flex items-center gap-4">
                                <!-- Clock Widget -->
                                <div class="hidden md:flex items-center gap-3 text-sm">
                                    <div class="flex items-center gap-2 px-3 py-1.5 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600">
                                    ...
                                    <div class="flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-800">
                                ...
                                <div x-data="{ open: false }" class="relative">
                                    <button @click="open = !open" 
                                            class="flex items-center gap-3 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-all duration-200">
                                        <div class="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center text-white font-medium text-sm shadow-lg">
                                            <?php echo strtoupper(substr($currentUser['full_name'], 0, 1)); ?>
                                        </div>
                                        <div class="hidden md:block text-left">
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo Security::escape($currentUser['full_name']); ?></div>
    ...
    <!-- Scripts --> 
                        ...
                        <!-- Collapsible Legacy Registry Section -->
                        <div x-data="{ open: <?php echo (strpos($_SERVER['PHP_SELF'], '/tarheta/') !== false || strpos($_SERVER['PHP_SELF'], '/legacy/') !== false) ? 'true' : 'false'; ?> }" class="mt-2">
                            <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                <span>Legacy Registry</span>
                            ...
                            <div x-show="open" x-collapse class="space-y-1 mt-1">
                                <a href="<?php echo BASE_URL; ?>/tarheta/list.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], '/tarheta/list.php') !== false ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo BASE_URL; ?>/legacy/list.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], '/legacy/list.php') !== false ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo BASE_URL; ?>/tarheta/import.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], '/tarheta/import.php') !== false ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Collapsible CFO Section -->
                        <div x-data="{ open: <?php echo (strpos($_SERVER['PHP_SELF'], 'cfo-') !== false || strpos($_SERVER['PHP_SELF'], 'reports/cfo') !== false) ? 'true' : 'false'; ?> }" class="mt-2">
                            <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                <span>CFO (Christian Family Org.)</span>
                                <svg :class="{'rotate-180': open}" class="w-4 h-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </button>
                            <div x-show="open" x-collapse class="space-y-1 mt-1">
                                <a href="<?php echo BASE_URL; ?>/cfo-registry.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'cfo-registry.php') !== false ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo BASE_URL; ?>/cfo-checker.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'cfo-checker.php') !== false ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo BASE_URL; ?>/reports/cfo-reports.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'reports/cfo-reports.php') !== false ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- NEW: Collapsible HDB Section -->
                        <div x-data="{ open: <?php echo (strpos($_SERVER['PHP_SELF'], 'hdb-') !== false) ? 'true' : 'false'; ?> }" class="mt-2">
                            <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                <span>🚸 HDB (Handog Di Bautisado)</span>
                                <svg :class="{'rotate-180': open}" class="w-4 h-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </button>
                            <div x-show="open" x-collapse class="space-y-1 mt-1">
                                <a href="<?php echo BASE_URL; ?>/hdb-registry.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'hdb-registry.php') !== false ? 'bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo BASE_URL; ?>/hdb-add.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'hdb-add.php') !== false ? 'bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                    Add HDB Child
                        ...
                        <!-- NEW: Collapsible PNK Section -->
                        <div x-data="{ open: <?php echo (strpos($_SERVER['PHP_SELF'], 'pnk-') !== false) ? 'true' : 'false'; ?> }" class="mt-2">
                            <button @click="open = !open" class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                <span>👥 PNK (Pagsamba ng Kabataan)</span>
                                <svg :class="{'rotate-180': open}" class="w-4 h-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </button>
                            <div x-show="open" x-collapse class="space-y-1 mt-1">
                                <a href="<?php echo BASE_URL; ?>/pnk-registry.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'pnk-registry.php') !== false ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo BASE_URL; ?>/pnk-add.php" 
                                   class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], 'pnk-add.php') !== false ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'; ?>">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                    Add PNK Member
            ...
            <div x-data="{ open: false }" x-cloak class="hidden">
                <!-- Mobile Header Bar -->
