...
<a href="<?php echo BASE_URL; ?>/dashboard.php" 
   class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg <?php echo basename($_SERVER['PHP_SELF']) === 'dashboard.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-100'; ?>">
...
<a href="<?php echo BASE_URL; ?>/legacy/list.php" 
   class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg <?php echo strpos($_SERVER['PHP_SELF'], '/legacy/list.php') !== false ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-100'; ?>">
    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
