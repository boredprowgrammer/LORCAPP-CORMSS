...
$cspPolicy = "default-src 'self'; " .
    ...
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.tailwindcss.com https://fonts.cdnfonts.com https://cdn.datatables.net; " .
                ...
                <div class="flex flex-col w-64 bg-white border-r border-gray-200">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                        ...
                        <a href="<?php echo BASE_URL; ?>/logbook-control-number.php" 
                           class="flex items-center px-4 py-3 text-sm font-medium rounded-lg <?php echo basename($_SERVER['PHP_SELF']) === 'logbook-control-number.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-100'; ?>">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
